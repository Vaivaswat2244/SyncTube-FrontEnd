...
const EditorProfile = () => {
    ...
    const review = reviews.find((review) => review.id === parseInt(profileId));
  ...
  return (
    ...
    <div className='flex backgroung w-full h-full  ' >
         ...
         <div className="w-[276.24px] h-[261.37px] ml-10 rounded-full shadow border border-white">
             <img className="w-[276.24px] h-[261.37px] bg-[#0e2a43] rounded-full shadow border border-white" src={review.image} />
         </div>
         <div className="w-[339.10px] mt-6 h-[650.96px] bg-[rgba(14, 42, 67, 0.5)] rounded-[10px] border border-white">
          ...
          <div className='flex flex-col w-[1136.74px] h-[965px] ml-16 space-y-18 mt-16 overflow-x-hidden mr-12 ' >
